      ...
      >
        ...
        <aside className="relative w-full shrink-0 bg-[#111111] px-4 py-3.5 md:w-[300px] md:border-l md:border-white/10 md:p-6">
          <button
            ...
            onClick={onClose}
            aria-label={t("close")}
            className="absolute right-3 top-3 flex h-9 w-9 cursor-pointer items-center justify-center rounded-full bg-white/10 text-lg text-white/80 transition hover:bg-white/15 md:right-4 md:top-4"
          >
            ×
          </button>
